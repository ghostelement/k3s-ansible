...
helm repo update
helm upgrade --install ctyk-yjk-Nursemobile harbor/ctyk-yjk-Nursemobile
```
...
To install the chart with the release name `ctyk-yjk-Nursemobile`:

```bash
helm install ctyk-yjk-Nursemobile .
```
...
To uninstall/delete the `ctyk-yjk-Nursemobile` deployment:

```bash
helm uninstall ctyk-yjk-Nursemobile
```
...
| `image.repository`                    | Image registry/name                                                                            | `komodorio/ctyk-yjk-Nursemobile`       |
| `image.tag`                           | Image tag                                                                                      |                                  |
...
| `updateStrategy.type`                 | Set up update strategy for ctyk-yjk-Nursemobile installation.                                        | `RollingUpdate`                  |             
| `extraArgs`                           | Set the arguments to be supplied to the ctyk-yjk-Nursemobile binary                                  | `[--no-browser, --bind=0.0.0.0]` |
...
```bash
helm upgrade --install ctyk-yjk-Nursemobile komodorio/ctyk-yjk-Nursemobile --set dashboard.allowWriteActions=true --set service.port=9090
```
