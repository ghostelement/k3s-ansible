...
helm.sh/chart: {{ include "kuboard.chart" . }}
{{ include "kuboard.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "kuboard.selectorLabels" -}}
app.kubernetes.io/name: {{ include "kuboard.fullname" . }}
...
*/}}
{{- define "kuboard.imagePullSecrets" -}}
